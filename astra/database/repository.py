...
class Repository:
    ...
    def insert_prediction(self, decision: Decision) -> int | None:
        row = _json_safe({
            ...
            "even_probability": decision.even_probability,
            "odd_probability": decision.odd_probability,
            "even_edge": decision.even_edge,
            "odd_edge": decision.odd_edge,
            "even_ev": decision.even_ev,
            "odd_ev": decision.odd_ev,
